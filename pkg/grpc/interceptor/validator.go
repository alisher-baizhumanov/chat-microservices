...
// ValidateGRPC is a gRPC unary server interceptor that validates the request
...
func ValidateGRPC(ctx context.Context, req any, _ *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (any, error) {
